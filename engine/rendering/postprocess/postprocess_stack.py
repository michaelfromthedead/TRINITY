...
class PostProcessStack:
    ...
    def execute_with_context(
        ...
        Args:
            ...
            context: PostProcessContext with per-frame state.
        """
        saved_settings: Dict[str, EffectSettings] = {}
        if context.camera_position and self._volumes:
            for effect in self._effects:
                saved_settings[effect.name] = effect.settings
        ...
        if saved_settings:
            for effect in self._effects:
                if effect.name in saved_settings:
                    effect.settings = saved_settings[effect.name]
