...
**Acceptance Criteria:**
- [x] Agents do not collide at avoidance_radius distance
- [x] Coincident agents separate (not stuck)
- [x] Priority weighting works (high priority agents push more)
- [x] MIN_DISTANCE_EPSILON prevents division by zero
...
- [x] State-specific behaviors activate correctly
- [x] Animation clips change with state
...
**Acceptance Criteria:**
- [x] Correct LOD level selected for distance ranges
- [x] Hysteresis prevents rapid switching
- [x] Boundary conditions handled correctly
- [x] Very far agents use lowest LOD
...
**Acceptance Criteria:**
- [x] Important bones are kept (root, spine, head)
- [x] Unimportant bones are culled (fingers, twist)
- [x] Reduced skeleton is valid (no orphan bones)
- [x] Bone count matches target
...
**Acceptance Criteria:**
- [x] All behavior parameters are configurable
- [x] Config changes take effect without restart
- [x] Invalid config values are rejected
