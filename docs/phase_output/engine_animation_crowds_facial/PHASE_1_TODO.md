...
**Acceptance Criteria:**
- [ ] Round-trip test: encode transform, decode, compare within epsilon
- [ ] Cubic Hermite interpolation produces smooth curves
- [ ] Atlas UV ranges are non-overlapping
- [ ] Edge case: single-frame animation handles correctly
...
- [ ] `InstanceBufferOverflowError` raised at max capacity
- [ ] Dynamic growth works correctly
- [ ] Memory layout matches expected byte sizes
...
- [ ] Batch priority ordering is correct
...
- [ ] Reduced skeleton LODs render correctly
- [ ] LOD transition modes work (instant, blend, dither)
