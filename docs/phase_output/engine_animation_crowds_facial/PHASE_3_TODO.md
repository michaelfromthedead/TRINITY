...
**Acceptance Criteria:**
- [ ] Sparse deltas apply correctly to target vertices
- [ ] Corrective shapes activate at correct thresholds
- [ ] Blend weights clamp to [0, 1] range
- [ ] NumPy vectorization is correct
...
**Acceptance Criteria:**
- [ ] All 21 Action Units map to blend shapes
- [ ] All 8 Ekman expressions produce correct AU combinations
- [ ] CONTEMPT is correctly asymmetric
- [ ] Bilateral support works (left/right independence)
...
**Acceptance Criteria:**
- [ ] Phoneme events convert to viseme events
- [ ] Coarticulation blends anticipation and carryover
- [ ] Zero-duration phonemes handled correctly
...
- [ ] Additive layers accumulate correctly
- [ ] Layer weights scale contributions
...
**Acceptance Criteria:**
- [ ] Source shapes map to target shapes
- [ ] Scale and offset apply correctly
- [ ] Many-to-one mappings accumulate
- [ ] Missing shapes handled gracefully
...
**Acceptance Criteria:**
- [ ] All 52 ARKit blend shape names are present
- [ ] Names match ARKit SDK exactly (case-sensitive)
- [ ] Blend shapes can be driven by ARKit data
