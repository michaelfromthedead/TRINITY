 ...
 */
export const SemanticVersionSchema = z.string().regex(/^\d+\.\d+\.\d+(-[a-zA-Z0-9]+(\.[a-zA-Z0-9]+)*)?$/, 'Invalid semantic version format');
/**
...
export const TypeDefinitionSchema = z.lazy(() => z.object({
    type: z.string(),
 ...
 */
export function validateNodeDefinition(data) {
 ...
 */
export function parseNodeDefinition(data) {
