 ...
 */
export declare const WORKFLOW_VERSION: SemanticVersion;
/**
 * Create an empty workflow.
 */
export declare function createEmptyWorkflow(): WorkflowSchema;
/**
 * Check if a workflow is empty.
 */
export declare function isEmptyWorkflow(workflow: WorkflowSchema): boolean;
/**
 * Get all node IDs in a workflow.
 */
export declare function getNodeIds(workflow: WorkflowSchema): readonly EntityId[];
/**
 * Get all links connected to a node.
 */
export declare function getNodeLinks(workflow: WorkflowSchema, nodeId: EntityId): readonly Link[];
/**
 * Get input links for a node.
 */
export declare function getInputLinks(workflow: WorkflowSchema, nodeId: EntityId): readonly Link[];
/**
 * Get output links for a node.
 */
export declare function getOutputLinks(workflow: WorkflowSchema, nodeId: EntityId): readonly Link[];
