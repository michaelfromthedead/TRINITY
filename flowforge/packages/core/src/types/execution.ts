...
export type ExecutionMode =
  ...
  | 'partial'   // Execute only changed nodes and downstream
  | 'single';   // Execute a single node
...
) => NodeOutputValues | Promise<NodeOutputValues>;

/**
 * Node validation function signature.
 */
export type NodeValidateFunction = (
  inputs: NodeInputValues,
  widgets: WidgetValues
) => ValidationResult;
